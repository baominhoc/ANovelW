...
export default function BrowseMangaCard({thumnailurl,title,description,status,style,chap}) {
    ...
    <Tippy placement="right" content={
      ...
      <Link href={`/manga/test`}>
        <div className="cursor-pointer flex flex-col group">
          ...
          <div className="mt-3">
            <p className="font-medium text-[16px] text-white capitalize line-clamp-1">{title}</p>
