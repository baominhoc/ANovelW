    ...
    <header className="mx-auto justify-center lg:px-24 px-6 relative w-full h-24 lg:mb-0 mb-8 lg:grid grid-cols-1 lg:grid-cols-12">
      <div className="flex col-span-2 lg:justify-start justify-center items-center mx-auto mt-6">
        ...
        <div className="group flex items-center gap-x-3">
          <img className="w-12 h-12 lg:ml-8 rounded-full" src="https://i.pinimg.com/236x/dc/d5/e0/dcd5e0d3ecce69288015e42e52c57c1d.jpg" />
          <div className="first-letter:text-red-500 first-letter:text-2xl text-2xl font-bold transition-all group-hover:text-gray-400 duration-200 cursor-pointer text-white">ANovelW</div>
          </div>
        </Link>
      </div>
              ...
              <div>
                <Menu.Button className="text-white transition-all flex items-center justify-center cursor-pointer social w-10 h-10 rounded-full">
                  ...
                  <div className=" cursor-pointer h-10 rounded-full flex items-center justify-center">
                    ...
                    <img className="w-8 h-8 rounded-full ml-2" src={user.avatar || `https://ui-avatars.com/api/?name=${user.username}`} />
                  </div>
                </Menu.Button>
              </div>
