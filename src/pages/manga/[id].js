...
export default function Home() {
    ...
    return (
        <>
            <NextSeo title={"Welcome to My World"} />
                ...
                <div id="body2" className="block lg:hidden">
                    ...
                    <div className="mt-4">
                        <p className="mt-2 line-clamp-5 text-center w-[450px]">
                            Hihi long toi tan nat khi nhan ra...
                            <br />
                           chit chit chit chit?
                        </p>
                    </div>
                                ...
                                <div class="flex w-full">
                                    ...
                                    <div class="ml-3 w-full">
                                        <div class="flex items-center">
                                            <p class="text-lg font-medium mr-2">Nuh uh</p>
                ...
                <div id="body" className="hidden lg:block">
                    <div id="user-info" className="flex -mt-2 space-x-8">
                        <div className="ml-12 -mt-24">
                            <img alt="anime" src="https://i.redd.it/966xjyo9d4tc1.jpeg" className="flex-shrink-1 rounded-lg w-[250px] min-h-[280px] max-h-[340px] relative object-cover bg-cover" />
                            <div className="mt-2">
                        ...
                        <div className="max-w-4xl">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="mt-2 line-clamp-3">
                                    Long Toi Tan Nat Khi Nhan Ra Toi La Gay.
                                    <br />
                                     chit chit chit chit?
                                </p>
                            </div>
                                        ...
                                        <div class="flex w-full">
                                            <div class="flex-shrink-0 w-[4rem] h-[4rem]">
                                                <img
                                                    alt="logo"
                                                    class="rounded-full"
                                                    src="https://media.tenor.com/bYABdxdveKcAAAAi/hololive-amelia-watson.gif"
                                                />
                                            </div>
                                            <div class="ml-3 w-full">
                                                <div class="flex items-center">
                                                    <p class="text-lg font-medium mr-2">NuhUh</p>
                                                    <p class="ml-2 text-xs text-white/50">{moment(new Date()).from()}</p>
